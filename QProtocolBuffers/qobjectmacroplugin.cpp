                                      ...
                                      string *error ) const
{
    try
    {
        string f = QFileInfo( QString::fromStdString( file->name() )  ).baseName().toStdString();
        string headerPath = QString::fromStdString( f )
                .append( ".pb.h" )
                .toStdString();
...
//        string sourcesPath = QString::fromStdString( f )
//                .append( ".pb.cpp" )
//                .toStdString();
